<div class="row">
      <div class="col-md-4 col-md-offset-4" style="margin-left:10px; font-size:30px">
        ...
        <a href="/mapa" data-toggle="tooltip" title="Visualizar Restaurantes no Mapa"><span class="glyphicon glyphicon-map-marker" style="margin-left:5px;font-size:30px"></span></a>
      </div>
  </div>