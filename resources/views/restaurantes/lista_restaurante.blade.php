		...
		<div class="col-md-9 ">
			<div class="panel">
				<div class="panel-body">
					...
					<div class="col-md-6">			
						<a href="/carrinho_de_compras/1" data-toggle="tooltip" title="Visualizar Cardapio">
						...
						<!--Inicio de uma nova coluna-->
					<div class="col-md-6">			
						<a href="/carrinho_de_compras/Qtd" data-toggle="tooltip" title="Visualizar Cardapio">
							<div class="panel panel-info">
								<div class="panel-body" style="background-color:#f1f1f1;padding:10px;cursor:move;border-radius:5px">
									<div class="row">
										<div class="col-md-3">
											<img src="img/tela.jpg" style="width:90px;height:60px" alt="Restaurante didatico icm" class="img-responsive">
										</div>
						...
						<!--Inicio de uma nova coluna-->
					<div class="col-md-6">			
						<a href="{{url('carrinho_de_compras')}}" data-toggle="tooltip" title="Visualizar Cardapio">
							<div class="panel panel-info">
								<div class="panel-body" style="background-color:#f1f1f1;padding:10px;cursor:move;border-radius:5px">
									<div class="row">
										<div class="col-md-3">
